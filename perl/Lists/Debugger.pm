...
=head2 Lists::Debugger Constructor
...
########################################################
   ...
   #$self->debug("In Lists::Debugger constructor");
...
#############################################
   ...
   my $Mailer = new Lists::Utilities::Mailer(Debugger=>$self);
   $Mailer->sendEmailToIT("Error $Lists::SETUP::DB_NAME in $package", "[$package, $line, ($date), $ENV{REMOTE_ADDR}]\n\n$msg\n\n$extra");
}
