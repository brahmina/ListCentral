package Lists::Utilities::GoogleImageGetter;
use strict;
...
##########################################################
# Lists::GoogleImageGetter 
##########################################################

=head1 NAME

   Lists::Utilities::GoogleImageGetter.pm

=head1 SYNOPSIS

   $GoogleImageGetter = new Lists::Utilities::GoogleImageGetter(Debugger);

=head1 DESCRIPTION

Used to get images from the internet

=head2 Lists::Utilities::GoogleImageGetter Constructor
...
########################################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::GoogleImageGetter constructor");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::GoogleImageGetter::getImageURLs");
