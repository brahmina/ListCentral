...
use Lists::SETUP;
use Lists::Utilities::StringFormatter;
...
=head1 SYNOPSIS
   ...
   $Amazon = new Lists::Utilities::Amazon(Debugger, OpenIDUserID);
...
########################################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::OpenID constructor");
...
=item B<Parameters :>
   ...
   1. $self - Reference to a Lists::DB::OpenID object
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::OpenID::getUserID with $OpenID");

   my $OpenID = Lists::Utilities::StringFormatter::canonicalizeURL($OpenID);
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::OpenID::getOpenIDsByUser with: $UserID");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::OpenID::attachOpenID with $OpenID, $UserID");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::OpenID::detachOpenID with $OpenID");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::OpenID::detachOpenIDByUser with $UserID");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::OpenID::authenticateOpenID");
   ...
   my $check_url = $claimed_identity->check_url(
                                                return_to  => "$Lists::SETUP::URL/openIDAuth.html?arg=",
                                                trust_root => "$Lists::SETUP::URL/",
   );
