package Lists::Utilities::GoogleAnalytics;
use strict;

use Lists::SETUP;

##########################################################
# Lists::GoogleAnalytics 
##########################################################

=head1 NAME

   Lists::Utilities::GoogleAnalytics.pm

=head1 SYNOPSIS

   $GoogleAnalyticsCode = Lists::Utilities::GoogleAnalytics::getCode();
...
#############################################
   ...
   my $googleTracking = $Lists::SETUP::GOOGLE_ANALYTICS_CODE;
