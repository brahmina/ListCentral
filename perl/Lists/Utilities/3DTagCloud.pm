package Lists::Utilities::3DTagCloud;
use strict;
...
=head1 NAME
   ...
   Lists::Utilities::3DTagCloud.pm

=head1 SYNOPSIS

   $3DTagCloud = new Lists::Utilities::3DTagCloud(Debugger);

=head1 DESCRIPTION

Used to get resources from the web

=head2 Lists::Utilities::3DTagCloud Constructor
...
########################################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::3DTagCloud constructor");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilitites::3DTagCloud::round with $number -> $rounded"); 
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilitites::3DTagCloud::generateTagCloudTags"); 
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilitites::3DTagCloud::generateTagCloudXML"); 
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilitites::3DTagCloud::get3DTagCloud"); 
