package Lists::Utilities::Ranker;
use strict;
...
=head1 NAME
   ...
   Lists::Utilities::Ranker.pm

=head1 SYNOPSIS

   $Ranker = new Lists::Utilities::Ranker(Debugger);

=head1 DESCRIPTION

Used to get resources from the web

=head2 Lists::Utilities::Ranker Constructor
...
########################################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::Ranker constructor");
...
=item B<Parameters :>
   ...
   1. $self - Reference to a Lists::Utilities::Ranker object
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::Ranker->setListPopularityPoints");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::Ranker->setListActivityPoints");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::Utilities::Ranker->setListRanking");
   ...
   foreach my $ID(keys %{$ListPoints}) {
      ...
      # 1209859500 is Date constant May 4th 2008, 12:05a (Marilyn's 30th b-day)
      my $direction = 1;
...
#############################################
   ...
   my $advert_row_file = "$Lists::SETUP::ADMIN_DIR_PATH/Utilities/Ranker/advert_row.html";
   my $AdvertsHTML = "";
...
#############################################
   ...
   my $adspace_row_file = "$Lists::SETUP::ADMIN_DIR_PATH/Utilities/Ranker/adspace_row.html";
...
#############################################
   ...
   my $adimpresssions_row = "$Lists::SETUP::ADMIN_DIR_PATH/Utilities/Ranker/adimpressions_row.html";
