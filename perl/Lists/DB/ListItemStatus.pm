package Lists::DB::ListItemStatus;
...
##########################################################
# Lists::DB::ListItemStatus 
##########################################################

=head1 NAME

   Lists::DB::ListItemStatus.pm

=head1 SYNOPSIS

   $ListItemStatus = new Lists::DB::ListItemStatus($dbh, $debug);
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::DB::ListItemStatus::getInitialStatus with set: $Set");
   ...
   my $sql_select = "SELECT MIN(ID) AS ID 
                     FROM $Lists::SETUP::DB_NAME.ListItemStatus 
                     WHERE StatusSet = $Set
                           AND Status > 0";
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::DB::ListItemStatus::getNextStatusSetID");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::ListsManager::getListItemStatusSetSelect");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::ListsManager::getListItemStatusSetJSArray");
