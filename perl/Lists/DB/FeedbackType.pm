...
##########################################################
# Lists::DB::FeedbackType 
##########################################################

=head1 NAME

   Lists::DB::FeedbackType.pm

=head1 SYNOPSIS

   $FeedbackType = new Lists::DB::FeedbackType($dbh, $debug);
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::DB::FeedbackType::get_all");

   my %FeedbackType;
   my $sql = "SELECT * FROM $Lists::SETUP::DB_NAME.FeedbackType";
