...
=head1 SYNOPSIS
   ...
   $Image = new Lists::DB::Image($dbh, $debug);
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::DB::Image::init");
...
#############################################
   ...
   $self->{Debugger}->debug("in Lists::ListManager::getImageInfo with ImageID: $ImageID");
   ...
   my %ImageInfo;
   $ImageInfo{ImageSRC} = "$Lists::SETUP::USER_CONTENT_DIRECTORY/$directory/$ImageID" . "L.$Image->{Extension}";
