package ListCentral::Admin::PageGetter;
use strict;
...
##########################################################
# ListCentral::Admin::PageGetter 
##########################################################

=head1 NAME

   ListCentral::Admin::PageGetter.pm

=head1 SYNOPSIS

   $ListPageGetter = new ListCentral::Admin::PageGetter($dbh, $debug);
...
########################################################
   ...
   $self->{Debugger}->debug("in ListCentral::Admin::PageGetter constructor");
