...
##########################################################
# ListCentral::DB::Region 
##########################################################

=head1 NAME

   ListCentral::DB::Region.pm

=head1 SYNOPSIS

   $Region = new ListCentral::DB::Region($dbh, $debug);
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::DB::Region::init");
