package ListCentral::DB::ListRatings;
...
##########################################################
# ListCentral::DB::ListRatings 
##########################################################

=head1 NAME

   ListCentral::DB::ListRatings.pm

=head1 SYNOPSIS

   $ListRatings = new ListCentral::DB::ListRatings($dbh, $debug);
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::DB::ListRatings::init");
...
=item B<Parameters :>
   ...
   1. $self - Reference to a BrahminaBurgess::PhotographRating object
   2. $ID - The List id
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::DB::ListRatings::getListRatingsHTML with ListID: $ListID");
   my $rating_sum = 0;
   my $sql_rating_sum = "SELECT SUM(Rating) AS RatingSum FROM $ListCentral::SETUP::DB_NAME.ListRatings WHERE ListID = $ListID";
   ...
   my $rating_count = 0;
   my $sql_rating_count = "SELECT COUNT(Rating) AS RatingCount FROM $ListCentral::SETUP::DB_NAME.ListRatings WHERE ListID = $ListID";
   ...
   my $width = int($rating) * $ListCentral::SETUP::LIST_RATINGS_WIDTH;
   ...
   if($Clickable){
      ...
      $html = qq~                   
                  <ul class="unit-rating">
                    <li class='current-rating' style="$width">&nbsp;</li>
                    <li><a href="javascript:alert('$ListCentral::SETUP::MESSAGES{NO_PERMISSION_RATE_LIST}')" title="1 out of 5" class="r1-unit" >&nbsp;</a></li>
                    <li><a href="javascript:alert('$ListCentral::SETUP::MESSAGES{NO_PERMISSION_RATE_LIST}')" title="2 out of 5" class="r2-unit" >&nbsp;</a></li>
                    <li><a href="javascript:alert('$ListCentral::SETUP::MESSAGES{NO_PERMISSION_RATE_LIST}')" title="3 out of 5" class="r3-unit" >&nbsp;</a></li>
                    <li><a href="javascript:alert('$ListCentral::SETUP::MESSAGES{NO_PERMISSION_RATE_LIST}')" title="4 out of 5" class="r4-unit" >&nbsp;</a></li>
                    <li><a href="javascript:alert('$ListCentral::SETUP::MESSAGES{NO_PERMISSION_RATE_LIST}')" title="5 out of 5" class="r5-unit" >&nbsp;</a></li>
                   </ul>
                  ~;
      $text = qq~<span class="RatingsText"><strong>$rating</strong> from $rating_count $votes</span> ~;
   }
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::DB::ListRatings::doRating with ListID: $ListID, Rating: $Rating, UserID: $UserID");
