package ListCentral::DB::UserLogins;
...
##########################################################
# ListCentral::DB::UserLogins 
##########################################################

=head1 NAME

   ListCentral::DB::UserLogins.pm

=head1 SYNOPSIS

   $UserLogins = new ListCentral::DB::UserLogins($dbh, $debug);
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::DB::UserLogins::init");
