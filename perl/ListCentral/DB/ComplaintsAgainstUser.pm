package ListCentral::DB::ComplaintsAgainstUser;
...
##########################################################
# ListCentral::DB::ComplaintsAgainstUser 
##########################################################

=head1 NAME

   ListCentral::DB::ComplaintsAgainstUser.pm

=head1 SYNOPSIS

   $ComplaintsAgainstUser = new ListCentral::DB::ComplaintsAgainstUser($dbh, $debug);
