package ListCentral::DB::AmazonLinks;
...
##########################################################
# ListCentral::DB::AmazonLinks 
##########################################################

=head1 NAME

   ListCentral::DB::AmazonLinks.pm

=head1 SYNOPSIS

   $AmazonLinks = new ListCentral::DB::AmazonLinks($dbh, $debug);
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::DB::AmazonLinks::init");
...
#############################################
   ...
   my $AmazonLink;
   my $sql = "SELECT * FROM $ListCentral::SETUP::DB_NAME.AmazonLinks WHERE ASIN = \"$ASIN\"";
