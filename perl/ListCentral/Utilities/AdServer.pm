package ListCentral::Utilities::AdServer;
use strict;

use ListCentral::SETUP;

##########################################################
# ListCentral::AdServer 
##########################################################

=head1 NAME

   ListCentral::Utilities::AdServer.pm

=head1 SYNOPSIS

   $AdServer = new ListCentral::Utilities::AdServer(Debugger);

=head1 DESCRIPTION

Used to get resources from the web

=head2 ListCentral::Utilities::AdServer Constructor
...
########################################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilities::AdServer constructor");
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Admin::AdvertManager::AddAdvert");
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Admin::AdvertManager::EditAdvert");
...
#############################################
   ...
   my $advert_row_file = "$ListCentral::SETUP::ADMIN_DIR_PATH/Utilities/AdServer/advert_row.html";
   my $AdvertsHTML = "";
...
#############################################
   ...
   my $adspace_row_file = "$ListCentral::SETUP::ADMIN_DIR_PATH/Utilities/AdServer/adspace_row.html";
...
#############################################
   ...
   my $adimpresssions_row = "$ListCentral::SETUP::ADMIN_DIR_PATH/Utilities/AdServer/adimpressions_row.html";
