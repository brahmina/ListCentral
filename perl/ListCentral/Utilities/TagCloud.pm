package ListCentral::Utilities::TagCloud;
use strict;
...
##########################################################
# ListCentral::TagCloud 
##########################################################

=head1 NAME

   ListCentral::Utilities::TagCloud.pm

=head1 SYNOPSIS

   $3DTagCloud = new ListCentral::Utilities::TagCloud(Debugger);

=head1 DESCRIPTION

Used to get resources from the web

=head2 ListCentral::Utilities::TagCloud Constructor
...
########################################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilities::TagCloud constructor");
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilitites::TagCloud::round with $number -> $rounded"); 
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilitites::TagCloud::generateTagCloudTags"); 
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilitites::TagCloud::generateTagCloudXML"); 
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilitites::TagCloud::get3DTagCloud"); 
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilitites::TagCloud::writeHTMLTagCloud"); 
   ...
   my $tagcloudHTMLFile = $ListCentral::SETUP::DIR_PATH . "/about/tagcloud.html";
