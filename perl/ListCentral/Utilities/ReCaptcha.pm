package ListCentral::Utilities::ReCaptcha;
use strict;
...
##########################################################
# ListCentral::Utilities::ReCaptcha 
##########################################################

=head1 NAME

   ListCentral::ReCaptcha.pm

=head1 SYNOPSIS

   $Mailer = new ListCentral::Utilities::ReCaptcha(Debugger);

=head1 DESCRIPTION

Used to create, manage, and send emails for the Lists system.

=head2 ListCentral::Utilities::ReCaptcha Constructor
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilities::ReCaptcha->getReCaptchaHTML");
...
#############################################
   ...
   $self->{Debugger}->debug("in ListCentral::Utilities::ReCaptcha->checkReCaptchaResponse");
