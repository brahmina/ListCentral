package ListCentral::Utilities::StringFormator;

use strict;
use ListCentral::SETUP;

##########################################################
# ListCentral::Utilities::StringFormater
##########################################################

=head1 NAME

    ListCentral::Utilities::StringFormater.pm

=head1 SYNOPSIS

   ListCentral::Utilities::StringFormater::fuction();
