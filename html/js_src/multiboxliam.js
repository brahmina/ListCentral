...
var multiBox = new Class({
	...
	options:{
		...
		movieSize: {w:800, h:520},//default width/height of movie
...
var Overlay = new Class({
	...
	initialize: function(options){
        ...
        this.iframe.inject(this.container,'inside');
        ...
        this.overlay.inject(this.container,'inside');
